  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        /* Strategy Board Quiz token mappings */
        bg: "var(--color-bg)",
        ...
        phase: {
          ...
          discussionBg: "var(--color-discussion-bg)",
          steal: "var(--color-steal)",
          stealBg: "var(--color-steal-bg)",
          correct: "var(--color-correct)",
          correctBg: "var(--color-correct-bg)",
          incorrect: "var(--color-incorrect)",
          incorrectBg: "var(--color-incorrect-bg)",
          warning: "var(--color-warning)",
        },
        // Team colors for games (hooked to CSS vars)
        team: {
          red: "var(--team-red)",
          blue: "var(--team-blue)",
      ...
      fontSize: {
        // Large display sizes for classroom readability
