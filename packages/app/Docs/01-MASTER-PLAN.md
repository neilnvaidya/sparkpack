...
The application lives at the **repository root** (the `sparkpack/` directory): `app/`, `components/`, and `lib/` sit directly under the repo root. There is no separate outer "app" or "classroom-games" folder.

**Canonical document index:** The [README’s Documentation table](README.md#documentation) is the single source of truth for which documents exist and in what order to read them. Every link there uses the `Docs/` path and exact filenames below.

Documents in `Docs/` (matches README):

| #   | Filename |
|-----|----------|
| 01  | [01-MASTER-PLAN.md](Docs/01-MASTER-PLAN.md) ← You are here |
| 02  | [02-system-architecture.md](Docs/02-system-architecture.md) |
| 04  | [04-template-system.md](Docs/04-template-system.md) |
| 05  | [05-ai-provider-abstraction.md](Docs/05-ai-provider-abstraction.md) |
| 06  | [06-state-management.md](Docs/06-state-management.md) |
| 07  | [07-api-specification.md](Docs/07-api-specification.md) |
| 08a | [08a-implementation-guide.md](Docs/08a-implementation-guide.md) |
| 08b | [08b-implementation-guide-part2.md](Docs/08b-implementation-guide-part2.md) |
| 12  | [12-quick-reference.md](Docs/12-quick-reference.md) |
